...
namespace Chet.QuartzNet.EFCore.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TriggerName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false, comment: "触发器名称"),
                    TriggerGroup = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false, defaultValue: "DEFAULT", comment: "触发器分组"),
                    CronExpression = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, comment: "Cron表达式"),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true, comment: "作业描述"),
                    JobTypeEnum = table.Column<int>(type: "int", nullable: false),
                    JobType = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, comment: "作业类型"),
                    ...
                    ApiTimeout = table.Column<int>(type: "int", nullable: false),
                    SkipSslValidation = table.Column<bool>(type: "bit", nullable: false),
